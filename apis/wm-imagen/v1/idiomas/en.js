module.exports = {
  ...
  faltaCarpeta: 'The folder for the image is missing.',
  faltaNombreImagen: 'The name of the image file is missing.',
  carpetaNoPermitida: 'No images are allowed in that folder.',
