...
let url = require('url')
let conf = require('./apis/apis-comun/config')
let multipart = require('./apis/apis-comun/multipart')
let fs = require('fs')
let modError = require('./apis/apis-comun/error')
...
http.createServer((req, res) => {
  ...
  let mfdBuffer
  // Buffer para el cuerpo multipart/form-data

  let cuerpo = ''

  let esMFD = esMultipartFormData(req)
  // True si content-type de la petición es multipart/form-data

  let mfdBufferIndex = 0
