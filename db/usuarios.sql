...
GRANT SELECT ON `cms\_contenidos`.* TO 'cms_usr'@'localhost';
GRANT SELECT, INSERT, UPDATE, DELETE ON `cms\_notificaciones`.* TO 'cms_usr'@'localhost';
...
GRANT SELECT, INSERT, UPDATE, DELETE ON `cms\_contenidos`.* TO 'cms_wm'@'localhost';
GRANT SELECT, INSERT, UPDATE, DELETE ON `cms\_articulus`.* TO 'cms_wm'@'localhost';
GRANT SELECT, INSERT, UPDATE, DELETE ON `cms\_notificaciones`.* TO 'cms_wm'@'localhost';
